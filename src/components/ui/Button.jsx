...
export const Button = ({ 
    ...
    const baseStyle = "inline-flex min-h-12 items-center justify-center gap-2 rounded-full px-8 py-2 font-medium transition-all duration-300 cursor-pointer whitespace-nowrap shrink-0 w-full sm:w-auto ";
